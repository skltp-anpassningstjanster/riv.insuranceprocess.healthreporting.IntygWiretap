...
public class WiretapMuleServer {


	public static final String MULE_SERVER_ID   = "wiretap";
 

	private static final Logger logger = LoggerFactory.getLogger(WiretapMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/wiretap-common.xml"
        //
